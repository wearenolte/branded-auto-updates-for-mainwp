...
<input class="regular-text ltr" name="server_token" type="text" id="server_token" value="<?php esc_attr_e( get_option( 'wp_post_mark_emails_config_server_token', '' ) ); ?>" placeholder="<?php _e( 'PostMark Server Token', 'wp_post_mark_emails' ); ?>" required>
</label>
<p class="description"><?php echo sprintf( wp_kses( __( 'Get your <a href="%s">server token</a> from your PostMark account. This is required for authentication on server specific endpoints.', 'wp_post_mark_emails' ), array(  'a' => array( 'href' => array() ) ) ), esc_url( 'https://postmarkapp.com/servers' ) ); ?></p>
</fieldset>
</td>
</tr>
<tr>
...
<input class="regular-text ltr" name="sender_signature" type="text" id="sender_signature" value="<?php esc_attr_e( get_option( 'wp_post_mark_emails_config_signature', '' ) ); ?>" placeholder="<?php _e( 'sender@example.com', 'wp_post_mark_emails' ); ?>" required>
<p class="description"><?php echo sprintf( wp_kses( __( 'Select from one of the validated <a href="%s">sender signatures</a> you have on your PostMark account.', 'wp_post_mark_emails' ), array(  'a' => array( 'href' => array() ) ) ), esc_url( 'https://postmarkapp.com/signatures' ) ); ?></p>
</label>
</fieldset>
</td>
</tr>
...
<p class="description"><?php echo sprintf( wp_kses( __( 'Find the <abr>HTML</abr> template you wish to use in the "Templates" section of <a href="%s">server</a> you wish to use.', 'wp_post_mark_emails' ), array(  'a' => array( 'href' => array() ) ) ), esc_url( 'https://postmarkapp.com/servers' ) ); ?></p>
</label>
</fieldset>
</td>
</tr>
