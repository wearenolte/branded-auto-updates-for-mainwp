...
if ( ! function_exists( 'wp_mail' ) && (bool) get_option( 'branded_auto_updates_for_mainwp_config_enable_post_mark', FALSE ) ) :
/**
 * This is the wp_mail function as implemented in the WordPress Core.
 ...
 *
 * @uses PHPMailer
 * @uses Postmark\PostmarkClient;
 * @uses Postmark\Models\PostmarkException;
 *
 ...
 */
function wp_mail( $to, $subject, $message, $headers = '', $attachments = array(), $server_token = '', $signature = '', $template_id = '' ) {
...
if ( ! function_exists( 'branded_auto_updates_for_mainwp_format_email' ) ) :
function branded_auto_updates_for_mainwp_format_email( $to, $body, $website_name, $website_url ) {
	return '<br>
			<div>
            <br>
